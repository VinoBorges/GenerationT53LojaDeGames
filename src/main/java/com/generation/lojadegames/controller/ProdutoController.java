...
public class ProdutoController
{
	...
	{
		return ResponseEntity.status(HttpStatus.OK).body(produtoRepository.findByPrecoLessThan(preco));
	}
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Produto> delProduto(@PathVariable Long id)
	{
